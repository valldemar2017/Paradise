...
/obj/item/seeds/tomato/debug
	...
	genes = list(/datum/plant_gene/trait/squash, /datum/plant_gene/trait/repeated_harvest, /datum/plant_gene/trait/maxchem, /datum/plant_gene/trait/smoke, /datum/plant_gene/trait/noreact)
	mutatelist = list(/obj/item/seeds/tomato/killer)
	reagents_add = list("plasma" = 0.1, "acid" = 0.5, "phoshporus" = 0.1)
	rarity = 20
