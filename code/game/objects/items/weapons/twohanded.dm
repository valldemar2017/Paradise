...
/obj/item/twohanded/attack(mob/living/target, mob/living/carbon/human/user)
...
/obj/item/twohanded/proc/nemesis_effects(mob/living/user, mob/living/target)
	return
